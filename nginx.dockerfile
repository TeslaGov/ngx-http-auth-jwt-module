...
RUN	./configure \
		...
		--with-cc-opt="-g -O2 -ffile-prefix-map=/data/builder/debuild/nginx-1.25.4/debian/debuild-base/nginx-${NGINX_VERSION}=. -fstack-protector-strong -Wformat -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fPIC -DNGX_HTTP_AUTH_JWT_MODULE_VERSION=\\\"${MODULE_VERSION}\\\"" \
